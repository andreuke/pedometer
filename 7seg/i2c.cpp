...
typedef Gpio<GPIOB_BASE,6>  I2C_CLK;
typedef Gpio<GPIOB_BASE,9>  I2C_SDA;
...
void I2C1_init(void){
	...
	/*GPIInitStruct.GPIO_Mode = GPIO_Mode_AF;			// set pins to alternate function
	...
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource9, GPIO_AF_I2C1); // SDA
        ...
        I2C_CLK::mode(Mode::ALTERNATE);
        I2C_CLK::speed(Speed::_50MHz);
        I2C_CLK::alternateFunction(4);
        
        I2C_SDA::mode(Mode::ALTERNATE);
        I2C_SDA::speed(Speed::_50MHz);
        I2C_SDA::alternateFunction(4);
	...
	I2C1_init(); // initialize I2C peripheral
        ...
        for(;;) {
            ...
            for(int i = 0; i < sizeof(number); i++) {
                I2C_write(I2C1, sendByte[i]);                                 // write one byte to the slave
            }
